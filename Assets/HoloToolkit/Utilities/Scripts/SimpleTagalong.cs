...
namespace HoloToolkit.Unity
{
    ...
    public class SimpleTagalong : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            // GetStringResult the Interpolator component and set some default parameters for
        ...
        protected virtual bool CalculateTagalongTargetPosition(Vector3 fromPosition, out Vector3 toPosition)
        {
            ...
            if (moveRight || moveLeft)
            {
                ...
                // GetStringResult the point along that ray that is on the plane and update
