...
{
    /// <summary>
    /// Sets Force PhotoCaptureText Serialization and visible meta files in all projects that use the HoloToolkit.
    /// </summary>
    [InitializeOnLoad]
    public class EnforceEditorSettings
    {
        static EnforceEditorSettings()
        {
            ...
            if (EditorSettings.serializationMode != SerializationMode.ForceText)
            {
                ...
                UnityEngine.Debug.Log("Setting Force PhotoCaptureText Serialization");
            }
